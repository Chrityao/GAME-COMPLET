function anim_hypotrochoid
% Hypotrochoid animation
...
% Always keep r1 > r2
% When r2 = len then it becomes hypocycloid
% Some good choices are r1=10, r2=4, len=4 
% r1=17, r2=7, len=3
% r1=47, r2=29, len=13
MIN_R1 = 10;
MAX_R1 = 100;
...
%radius of fixed circle, in which smaller circle rolls
...
draw_hypo(r1,r2,len,dtheta);

end

function draw_hypo(r1,r2,len,dtheta)
% function to animate rolling circle.
% nRotations is the number of rotation the rolling circle will do to 
% complete the hypotrochoid. r1/r2 give the number of rotation only when r2 
...
axis equal
box on
axis((r1+len)*[-1.2 1.2 -1.2 1.2]) %fix axis
